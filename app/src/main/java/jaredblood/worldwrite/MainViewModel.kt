...
class MainViewModel : ObservableViewModel(), LifecycleObserver{
    ...
    var selectedWriteHasRatedGood: ObservableBoolean = ObservableBoolean(true)
    var selectedWriteHasRatedPoor: ObservableBoolean = ObservableBoolean(true)
    ...
    fun rateGood() {
        ...
        if(write != null) {
            ...
            selectedWriteHasRatedGood.set(true)
        }
    }
    ...
    fun ratePoor() {
        ...
        if(write != null) {
            ...
            usersDatabaseReference.setValue(currentUser)
            selectedWriteHasRatedPoor.set(true)
        }
    }
